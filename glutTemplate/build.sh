...
echo "assembling client program!"
  if [ $strval1 == $strval2 ]; then
   echo ".............................................."
   g++ -w -o GeminiViewer main.cpp -lGLU -lglut -lGL -lxmlrpc -pthread -lsfml-system -lsfml-audio -L/usr/local/curl/lib -lcurl -L/usr/local/openssl/lib -lssl -lcrypto -ldl -lz  lib/imgui/backends/imgui_impl_glut.cpp lib/imgui/backends/imgui_impl_opengl2.cpp lib/imgui/imgui*.cpp;
  else
